...
- API version: 1.0.0
- Package version: v1.0.0-beta.0-258-g251b1a45b
...
*DefaultApi* | [**v1alpha3vm_removeinterface**](docs/DefaultApi.md#v1alpha3vm_removeinterface) | **PUT** /apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/removeinterface | 
...
*DefaultApi* | [**v1alpha3vmi_removeinterface**](docs/DefaultApi.md#v1alpha3vmi_removeinterface) | **PUT** /apis/subresources.kubevirt.io/v1alpha3/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/removeinterface | 
...
*DefaultApi* | [**v1vm_removeinterface**](docs/DefaultApi.md#v1vm_removeinterface) | **PUT** /apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachines/{name:[a-z0-9][a-z0-9\-]*}/removeinterface | 
...
*DefaultApi* | [**v1vmi_removeinterface**](docs/DefaultApi.md#v1vmi_removeinterface) | **PUT** /apis/subresources.kubevirt.io/v1/namespaces/{namespace:[a-z0-9][a-z0-9\-]*}/virtualmachineinstances/{name:[a-z0-9][a-z0-9\-]*}/removeinterface | 
...
## Documentation For Models
 ...
 - [V1RemoveInterfaceOptions](docs/V1RemoveInterfaceOptions.md)
