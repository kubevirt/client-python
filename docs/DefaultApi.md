...
[**delete_collection_namespaced_migration**](DefaultApi.md#delete_collection_namespaced_migration) | **DELETE** /apis/kubevirt.io/v1alpha1/namespaces/{namespace}/migrations | Delete a collection of Migration objects.
...
[**patch_namespaced_migration**](DefaultApi.md#patch_namespaced_migration) | **PATCH** /apis/kubevirt.io/v1alpha1/namespaces/{namespace}/migrations/{name} | Patch a Migration object.
...
# **delete_collection_namespaced_migration**
> V1Status delete_collection_namespaced_migration(_continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    # Delete a collection of Migration objects.
    api_response = api_instance.delete_collection_namespaced_migration(_continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->delete_collection_namespaced_migration: %s\n" % e)
```
...
> V1Status delete_namespaced_migration(body, namespace, name, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy)
...
try: 
    # Delete a Migration object.
    api_response = api_instance.delete_namespaced_migration(body, namespace, name, grace_period_seconds=grace_period_seconds, orphan_dependents=orphan_dependents, propagation_policy=propagation_policy)
    pprint(api_response)
except ApiException as e:
...
> V1MigrationList list_migration_for_all_namespaces(_continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    # Get a list of all Migration objects.
    api_response = api_instance.list_migration_for_all_namespaces(_continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> V1MigrationList list_namespaced_migration(namespace, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    # Get a list of Migration objects.
    api_response = api_instance.list_namespaced_migration(namespace, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
# **patch_namespaced_migration**
> V1Migration patch_namespaced_migration(body)
...
try: 
    # Patch a Migration object.
    api_response = api_instance.patch_namespaced_migration(body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling DefaultApi->patch_namespaced_migration: %s\n" % e)
```
...
> V1Migration read_namespaced_migration(name, namespace, exact=exact, export=export)
...
try: 
    # Get a Migration object.
    api_response = api_instance.read_namespaced_migration(name, namespace, exact=exact, export=export)
    pprint(api_response)
except ApiException as e:
...
> V1WatchEvent watch_migration_list_for_all_namespaces(_continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    # Watch a MigrationList object.
    api_response = api_instance.watch_migration_list_for_all_namespaces(_continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
...
> V1WatchEvent watch_namespaced_migration(namespace, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
...
try: 
    # Watch a Migration object.
    api_response = api_instance.watch_namespaced_migration(namespace, _continue=_continue, field_selector=field_selector, include_uninitialized=include_uninitialized, label_selector=label_selector, limit=limit, resource_version=resource_version, timeout_seconds=timeout_seconds, watch=watch)
    pprint(api_response)
except ApiException as e:
