...
**port_ranges** | [**list[V1PortRange]**](V1PortRange.md) | List of port ranges to be forwarded to the virtual machine. Mutually exclusive with ports. Only supported on masquerade interfaces. This feature is in Alpha. | [optional] 
**ports** | [**list[V1Port]**](V1Port.md) | List of ports to be forwarded to the virtual machine. Mutually exclusive with portRanges. | [optional] 
