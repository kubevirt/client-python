...
**synchronization_placement** | [**V1ComponentConfig**](V1ComponentConfig.md) | SynchronizationPlacement allows customization of node placement for synchronization controllers. This can be used to schedule sync controllers on specific nodes (e.g., nodes with access to the cross-cluster migration network). By default, sync controllers use control-plane placement. | [optional] 
