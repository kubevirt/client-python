...
**volume_mode** | [**V1PersistentVolumeMode**](V1PersistentVolumeMode.md) | volumeMode defines what type of volume is required by the claim. Value of Filesystem is implied when not included in claim spec. This is a beta feature. | [optional] 
