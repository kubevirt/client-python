...
------------ | ------------- | ------------- | -------------
**added_overhead** | [**IoK8sApimachineryPkgApiResourceQuantity**](IoK8sApimachineryPkgApiResourceQuantity.md) | AddedOverhead determines the memory overhead that will be reserved for the VM. It increases the virt-launcher pod memory limit. | [optional] 
