...
**target_memory_overhead** | [**K8sIoApimachineryPkgApiResourceQuantity**](K8sIoApimachineryPkgApiResourceQuantity.md) | TargetMemoryOverhead is the memory overhead of the target virt-launcher pod | [optional] 
