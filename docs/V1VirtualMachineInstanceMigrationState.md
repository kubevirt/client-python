...
**end_timestamp** | [**IoK8sApimachineryPkgApisMetaV1Time**](IoK8sApimachineryPkgApisMetaV1Time.md) | The time the migration action ended | [optional] 
...
**migration_configuration** | [**V1VMIMConfigurationOptions**](V1VMIMConfigurationOptions.md) | Migration configurations to apply | [optional] 
...
**start_timestamp** | [**IoK8sApimachineryPkgApisMetaV1Time**](IoK8sApimachineryPkgApisMetaV1Time.md) | The time the migration action began | [optional] 
...
**target_memory_overhead** | [**IoK8sApimachineryPkgApiResourceQuantity**](IoK8sApimachineryPkgApiResourceQuantity.md) | TargetMemoryOverhead is the memory overhead of the target virt-launcher pod | [optional] 
...
**target_node_domain_ready_timestamp** | [**IoK8sApimachineryPkgApisMetaV1Time**](IoK8sApimachineryPkgApisMetaV1Time.md) | The timestamp at which the target node detects the domain is active | [optional] 
