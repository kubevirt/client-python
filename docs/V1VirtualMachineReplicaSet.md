...
**status** | [**V1VMReplicaSetStatus**](V1VMReplicaSetStatus.md) | Status is the high level overview of how the VM is doing. It contains information available to controllers and users. | [optional] 
