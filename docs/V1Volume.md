...
**container_path** | [**V1ContainerPathVolumeSource**](V1ContainerPathVolumeSource.md) | ContainerPath exposes a path from the virt-launcher container to the VM via virtiofs. The path must correspond to an existing volumeMount in the compute container. | [optional] 
