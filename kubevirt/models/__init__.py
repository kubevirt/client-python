...
from .io_k8s_api_core_v1_pod_dns_config import IoK8sApiCoreV1PodDNSConfig
from .io_k8s_api_core_v1_pod_dns_config_option import IoK8sApiCoreV1PodDNSConfigOption
...
from .io_k8s_api_core_v1_topology_spread_constraint import IoK8sApiCoreV1TopologySpreadConstraint
from .io_k8s_api_core_v1_typed_local_object_reference import IoK8sApiCoreV1TypedLocalObjectReference
from .io_k8s_api_core_v1_typed_object_reference import IoK8sApiCoreV1TypedObjectReference
from .io_k8s_api_core_v1_volume_resource_requirements import IoK8sApiCoreV1VolumeResourceRequirements
...
from .io_k8s_apimachinery_pkg_apis_meta_v1_condition import IoK8sApimachineryPkgApisMetaV1Condition
from .io_k8s_apimachinery_pkg_apis_meta_v1_delete_options import IoK8sApimachineryPkgApisMetaV1DeleteOptions
from .io_k8s_apimachinery_pkg_apis_meta_v1_duration import IoK8sApimachineryPkgApisMetaV1Duration
from .io_k8s_apimachinery_pkg_apis_meta_v1_fields_v1 import IoK8sApimachineryPkgApisMetaV1FieldsV1
...
from .io_k8s_apimachinery_pkg_apis_meta_v1_managed_fields_entry import IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry
...
from .io_k8s_apimachinery_pkg_apis_meta_v1_patch import IoK8sApimachineryPkgApisMetaV1Patch
from .io_k8s_apimachinery_pkg_apis_meta_v1_preconditions import IoK8sApimachineryPkgApisMetaV1Preconditions
from .io_k8s_apimachinery_pkg_apis_meta_v1_root_paths import IoK8sApimachineryPkgApisMetaV1RootPaths
...
from .io_k8s_apimachinery_pkg_apis_meta_v1_shard_info import IoK8sApimachineryPkgApisMetaV1ShardInfo
...
from .v1_changed_block_tracking_selectors import V1ChangedBlockTrackingSelectors
from .v1_changed_block_tracking_status import V1ChangedBlockTrackingStatus
from .v1_chassis import V1Chassis
from .v1_claim_request import V1ClaimRequest
...
from .v1_disk_io_threads import V1DiskIOThreads
...
from .v1_downtime_tuning_options import V1DowntimeTuningOptions
...
from .v1_experimental_migration_options import V1ExperimentalMigrationOptions
...
from .v1_interface_passt_binding import V1InterfacePasstBinding
...
from .v1_object_graph_node import V1ObjectGraphNode
from .v1_object_graph_options import V1ObjectGraphOptions
from .v1_pit_timer import V1PITTimer
from .v1_panic_device import V1PanicDevice
...
from .v1_port_range import V1PortRange
...
from .v1_reserved_overhead import V1ReservedOverhead
...
from .v1_sevsnp import V1SEVSNP
...
from .v1_stall_detector_options import V1StallDetectorOptions
...
from .v1_vmim_configuration_options import V1VMIMConfigurationOptions
from .v1_video_device import V1VideoDevice
from .v1_virt_template_deployment import V1VirtTemplateDeployment
from .v1_virtual_machine import V1VirtualMachine
from .v1_virtual_machine_condition import V1VirtualMachineCondition
from .v1_virtual_machine_export import V1VirtualMachineExport
from .v1_virtual_machine_export_backup import V1VirtualMachineExportBackup
from .v1_virtual_machine_export_backup_endpoint import V1VirtualMachineExportBackupEndpoint
from .v1_virtual_machine_export_link import V1VirtualMachineExportLink
from .v1_virtual_machine_export_links import V1VirtualMachineExportLinks
from .v1_virtual_machine_export_list import V1VirtualMachineExportList
from .v1_virtual_machine_export_manifest import V1VirtualMachineExportManifest
from .v1_virtual_machine_export_spec import V1VirtualMachineExportSpec
from .v1_virtual_machine_export_status import V1VirtualMachineExportStatus
from .v1_virtual_machine_export_volume import V1VirtualMachineExportVolume
from .v1_virtual_machine_export_volume_format import V1VirtualMachineExportVolumeFormat
from .v1_virtual_machine_instance import V1VirtualMachineInstance
from .v1_virtual_machine_instance_backup_status import V1VirtualMachineInstanceBackupStatus
from .v1_virtual_machine_instance_backup_volume_info import V1VirtualMachineInstanceBackupVolumeInfo
...
from .v1_virtual_machine_instance_migration_source import V1VirtualMachineInstanceMigrationSource
from .v1_virtual_machine_instance_migration_source_state import V1VirtualMachineInstanceMigrationSourceState
...
from .v1_virtual_machine_instance_migration_target import V1VirtualMachineInstanceMigrationTarget
from .v1_virtual_machine_instance_migration_target_state import V1VirtualMachineInstanceMigrationTargetState
...
from .v1_virtual_machine_instance_resource_claim import V1VirtualMachineInstanceResourceClaim
...
from .v1alpha1_backup_checkpoint import V1alpha1BackupCheckpoint
from .v1alpha1_backup_options import V1alpha1BackupOptions
from .v1alpha1_backup_volume_info import V1alpha1BackupVolumeInfo
...
from .v1alpha1_virtual_machine_backup import V1alpha1VirtualMachineBackup
from .v1alpha1_virtual_machine_backup_list import V1alpha1VirtualMachineBackupList
from .v1alpha1_virtual_machine_backup_spec import V1alpha1VirtualMachineBackupSpec
from .v1alpha1_virtual_machine_backup_status import V1alpha1VirtualMachineBackupStatus
...
from .v1beta1_virtual_machine_clone import V1beta1VirtualMachineClone
from .v1beta1_virtual_machine_clone_list import V1beta1VirtualMachineCloneList
from .v1beta1_virtual_machine_clone_spec import V1beta1VirtualMachineCloneSpec
from .v1beta1_virtual_machine_clone_status import V1beta1VirtualMachineCloneStatus
from .v1beta1_virtual_machine_clone_template_filters import V1beta1VirtualMachineCloneTemplateFilters
...
from .v1beta1_virtual_machine_opportunistic_update_strategy import V1beta1VirtualMachineOpportunisticUpdateStrategy
from .v1beta1_virtual_machine_pool import V1beta1VirtualMachinePool
from .v1beta1_virtual_machine_pool_autohealing_strategy import V1beta1VirtualMachinePoolAutohealingStrategy
from .v1beta1_virtual_machine_pool_condition import V1beta1VirtualMachinePoolCondition
from .v1beta1_virtual_machine_pool_list import V1beta1VirtualMachinePoolList
from .v1beta1_virtual_machine_pool_name_generation import V1beta1VirtualMachinePoolNameGeneration
...
from .v1beta1_virtual_machine_pool_proactive_scale_in_strategy import V1beta1VirtualMachinePoolProactiveScaleInStrategy
from .v1beta1_virtual_machine_pool_proactive_update_strategy import V1beta1VirtualMachinePoolProactiveUpdateStrategy
from .v1beta1_virtual_machine_pool_scale_in_strategy import V1beta1VirtualMachinePoolScaleInStrategy
from .v1beta1_virtual_machine_pool_selection_policy import V1beta1VirtualMachinePoolSelectionPolicy
from .v1beta1_virtual_machine_pool_selectors import V1beta1VirtualMachinePoolSelectors
from .v1beta1_virtual_machine_pool_spec import V1beta1VirtualMachinePoolSpec
from .v1beta1_virtual_machine_pool_status import V1beta1VirtualMachinePoolStatus
from .v1beta1_virtual_machine_pool_unmanaged_strategy import V1beta1VirtualMachinePoolUnmanagedStrategy
from .v1beta1_virtual_machine_pool_update_strategy import V1beta1VirtualMachinePoolUpdateStrategy
...
from .v1beta1_virtual_machine_template_spec import V1beta1VirtualMachineTemplateSpec
