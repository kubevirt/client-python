...
from .v1alpha2_cpu_instancetype import V1alpha2CPUInstancetype
from .v1alpha2_cpu_preferences import V1alpha2CPUPreferences
from .v1alpha2_clock_preferences import V1alpha2ClockPreferences
from .v1alpha2_device_preferences import V1alpha2DevicePreferences
from .v1alpha2_feature_preferences import V1alpha2FeaturePreferences
from .v1alpha2_firmware_preferences import V1alpha2FirmwarePreferences
from .v1alpha2_machine_preferences import V1alpha2MachinePreferences
from .v1alpha2_memory_instancetype import V1alpha2MemoryInstancetype
from .v1alpha2_virtual_machine_cluster_instancetype import V1alpha2VirtualMachineClusterInstancetype
from .v1alpha2_virtual_machine_cluster_instancetype_list import V1alpha2VirtualMachineClusterInstancetypeList
from .v1alpha2_virtual_machine_cluster_preference import V1alpha2VirtualMachineClusterPreference
from .v1alpha2_virtual_machine_cluster_preference_list import V1alpha2VirtualMachineClusterPreferenceList
from .v1alpha2_virtual_machine_instancetype import V1alpha2VirtualMachineInstancetype
from .v1alpha2_virtual_machine_instancetype_list import V1alpha2VirtualMachineInstancetypeList
from .v1alpha2_virtual_machine_instancetype_spec import V1alpha2VirtualMachineInstancetypeSpec
from .v1alpha2_virtual_machine_preference import V1alpha2VirtualMachinePreference
from .v1alpha2_virtual_machine_preference_list import V1alpha2VirtualMachinePreferenceList
from .v1alpha2_virtual_machine_preference_spec import V1alpha2VirtualMachinePreferenceSpec
from .v1alpha2_volume_preferences import V1alpha2VolumePreferences
