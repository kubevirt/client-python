...
class IoK8sApiCoreV1TopologySpreadConstraint(object):
    """
    ...
    def match_label_keys(self):
        """
        Gets the match_label_keys of this IoK8sApiCoreV1TopologySpreadConstraint.
        ...
        :return: The match_label_keys of this IoK8sApiCoreV1TopologySpreadConstraint.
        :rtype: list[str]
        """
    ...
    def match_label_keys(self, match_label_keys):
        """
        Sets the match_label_keys of this IoK8sApiCoreV1TopologySpreadConstraint.
        MatchLabelKeys is a set of pod label keys to select the pods over which spreading will be calculated. The keys are used to lookup values from the incoming pod labels, those key-value labels are ANDed with labelSelector to select the group of existing pods over which spreading will be calculated for the incoming pod. The same key is forbidden to exist in both MatchLabelKeys and LabelSelector. MatchLabelKeys cannot be set when LabelSelector isn't set. Keys that don't exist in the incoming pod labels will be ignored. A null or empty list means only match against labelSelector.  This is a beta field and requires the MatchLabelKeysInPodTopologySpread feature gate to be enabled (enabled by default).

        :param match_label_keys: The match_label_keys of this IoK8sApiCoreV1TopologySpreadConstraint.
        :type: list[str]
        """
    ...
    def min_domains(self):
        """
        Gets the min_domains of this IoK8sApiCoreV1TopologySpreadConstraint.
        ...
        :return: The min_domains of this IoK8sApiCoreV1TopologySpreadConstraint.
        :rtype: int
        """
    ...
    def min_domains(self, min_domains):
        """
        Sets the min_domains of this IoK8sApiCoreV1TopologySpreadConstraint.
        MinDomains indicates a minimum number of eligible domains. When the number of eligible domains with matching topology keys is less than minDomains, Pod Topology Spread treats \"global minimum\" as 0, and then the calculation of Skew is performed. And when the number of eligible domains with matching topology keys equals or greater than minDomains, this value has no effect on scheduling. As a result, when the number of eligible domains is less than minDomains, scheduler won't schedule more than maxSkew Pods to those domains. If value is nil, the constraint behaves as if MinDomains is equal to 1. Valid values are integers greater than 0. When value is not nil, WhenUnsatisfiable must be DoNotSchedule.  For example, in a 3-zone cluster, MaxSkew is set to 2, MinDomains is set to 5 and pods with the same labelSelector spread as 2/2/2: | zone1 | zone2 | zone3 | |  P P  |  P P  |  P P  | The number of domains is less than 5(MinDomains), so \"global minimum\" is treated as 0. In this situation, new pod with the same labelSelector cannot be scheduled, because computed skew will be 3(3 - 0) if new Pod is scheduled to any of the three zones, it will violate MaxSkew.

        :param min_domains: The min_domains of this IoK8sApiCoreV1TopologySpreadConstraint.
        :type: int
        """
    ...
    def node_affinity_policy(self):
        """
        Gets the node_affinity_policy of this IoK8sApiCoreV1TopologySpreadConstraint.
        ...
        :return: The node_affinity_policy of this IoK8sApiCoreV1TopologySpreadConstraint.
        :rtype: str
        """
    ...
    def node_affinity_policy(self, node_affinity_policy):
        """
        Sets the node_affinity_policy of this IoK8sApiCoreV1TopologySpreadConstraint.
        NodeAffinityPolicy indicates how we will treat Pod's nodeAffinity/nodeSelector when calculating pod topology spread skew. Options are: - Honor: only nodes matching nodeAffinity/nodeSelector are included in the calculations. - Ignore: nodeAffinity/nodeSelector are ignored. All nodes are included in the calculations.  If this value is nil, the behavior is equivalent to the Honor policy.  Possible enum values:  - `\"Honor\"` means use this scheduling directive when calculating pod topology spread skew.  - `\"Ignore\"` means ignore this scheduling directive when calculating pod topology spread skew.

        :param node_affinity_policy: The node_affinity_policy of this IoK8sApiCoreV1TopologySpreadConstraint.
        :type: str
        """
    ...
    def node_taints_policy(self):
        """
        Gets the node_taints_policy of this IoK8sApiCoreV1TopologySpreadConstraint.
        ...
        :return: The node_taints_policy of this IoK8sApiCoreV1TopologySpreadConstraint.
        :rtype: str
        """
    ...
    def node_taints_policy(self, node_taints_policy):
        """
        Sets the node_taints_policy of this IoK8sApiCoreV1TopologySpreadConstraint.
        NodeTaintsPolicy indicates how we will treat node taints when calculating pod topology spread skew. Options are: - Honor: nodes without taints, along with tainted nodes for which the incoming pod has a toleration, are included. - Ignore: node taints are ignored. All nodes are included.  If this value is nil, the behavior is equivalent to the Ignore policy.  Possible enum values:  - `\"Honor\"` means use this scheduling directive when calculating pod topology spread skew.  - `\"Ignore\"` means ignore this scheduling directive when calculating pod topology spread skew.

        :param node_taints_policy: The node_taints_policy of this IoK8sApiCoreV1TopologySpreadConstraint.
        :type: str
        """
        allowed_values = ["Honor", "Ignore"]
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, IoK8sApiCoreV1TopologySpreadConstraint):
            return False
