...
class IoK8sApimachineryPkgApisMetaV1DeleteOptions(object):
    ...
    def ignore_store_read_error_with_cluster_breaking_potential(self):
        """
        Gets the ignore_store_read_error_with_cluster_breaking_potential of this IoK8sApimachineryPkgApisMetaV1DeleteOptions.
        ...
        :return: The ignore_store_read_error_with_cluster_breaking_potential of this IoK8sApimachineryPkgApisMetaV1DeleteOptions.
        :rtype: bool
        """
    ...
    def ignore_store_read_error_with_cluster_breaking_potential(self, ignore_store_read_error_with_cluster_breaking_potential):
        """
        Sets the ignore_store_read_error_with_cluster_breaking_potential of this IoK8sApimachineryPkgApisMetaV1DeleteOptions.
        if set to true, it will trigger an unsafe deletion of the resource in case the normal deletion flow fails with a corrupt object error. A resource is considered corrupt if it can not be retrieved from the underlying storage successfully because of a) its data can not be transformed e.g. decryption failure, or b) it fails to decode into an object. NOTE: unsafe deletion ignores finalizer constraints, skips precondition checks, and removes the object from the storage. WARNING: This may potentially break the cluster if the workload associated with the resource being unsafe-deleted relies on normal deletion flow. Use only if you REALLY know what you are doing. The default value is false, and the user must opt in to enable it

        :param ignore_store_read_error_with_cluster_breaking_potential: The ignore_store_read_error_with_cluster_breaking_potential of this IoK8sApimachineryPkgApisMetaV1DeleteOptions.
        :type: bool
        """
