...
class K8sIoApiCoreV1NodeSelectorTerm(object):
    """
    ...
    """
    swagger_types = {
        'match_expressions': 'list[K8sIoApiCoreV1NodeSelectorRequirement]',
        'match_fields': 'list[K8sIoApiCoreV1NodeSelectorRequirement]'
    }
    ...
    def __init__(self, match_expressions=None, match_fields=None):
        """
        K8sIoApiCoreV1NodeSelectorTerm - a model defined in Swagger
        """
    ...
    def match_expressions(self):
        """
        Gets the match_expressions of this K8sIoApiCoreV1NodeSelectorTerm.
    ...
    def match_expressions(self, match_expressions):
        """
        Sets the match_expressions of this K8sIoApiCoreV1NodeSelectorTerm.
        A list of node selector requirements by node's labels.
    ...
    def match_fields(self):
        """
        Gets the match_fields of this K8sIoApiCoreV1NodeSelectorTerm.
    ...
    def match_fields(self, match_fields):
        """
        Sets the match_fields of this K8sIoApiCoreV1NodeSelectorTerm.
        A list of node selector requirements by node's fields.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, K8sIoApiCoreV1NodeSelectorTerm):
            return False
