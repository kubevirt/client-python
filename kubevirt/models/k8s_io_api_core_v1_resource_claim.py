...
class K8sIoApiCoreV1ResourceClaim(object):
    """
    ...
    def name(self):
        """
        Gets the name of this K8sIoApiCoreV1ResourceClaim.
        Name must match the name of one entry in pod.spec.resourceClaims of the Pod where this field is used. It makes that resource available inside a container.

        :return: The name of this K8sIoApiCoreV1ResourceClaim.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this K8sIoApiCoreV1ResourceClaim.
        Name must match the name of one entry in pod.spec.resourceClaims of the Pod where this field is used. It makes that resource available inside a container.

        :param name: The name of this K8sIoApiCoreV1ResourceClaim.
        :type: str
        """
        if name is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, K8sIoApiCoreV1ResourceClaim):
            return False
