...
class K8sIoApimachineryPkgApisMetaV1ObjectMeta(object):
    """
    ...
    swagger_types = {
        ...
        'generation': 'int',
        'labels': 'dict(str, str)',
        'managed_fields': 'list[K8sIoApimachineryPkgApisMetaV1ManagedFieldsEntry]',
        'name': 'str',
        'namespace': 'str',
        'owner_references': 'list[K8sIoApimachineryPkgApisMetaV1OwnerReference]',
    ...
    def deletion_grace_period_seconds(self):
        """
        Gets the deletion_grace_period_seconds of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        Number of seconds allowed for this object to gracefully terminate before it will be removed from the system. Only set when deletionTimestamp is also set. May only be shortened. Read-only.

        :return: The deletion_grace_period_seconds of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :rtype: int
        """
    ...
    def deletion_grace_period_seconds(self, deletion_grace_period_seconds):
        """
        Sets the deletion_grace_period_seconds of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        Number of seconds allowed for this object to gracefully terminate before it will be removed from the system. Only set when deletionTimestamp is also set. May only be shortened. Read-only.

        :param deletion_grace_period_seconds: The deletion_grace_period_seconds of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :type: int
        """
    ...
    def deletion_timestamp(self):
        """
        Gets the deletion_timestamp of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        ...
        :return: The deletion_timestamp of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
    ...
    def deletion_timestamp(self, deletion_timestamp):
        """
        Sets the deletion_timestamp of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        DeletionTimestamp is RFC 3339 date and time at which this resource will be deleted. This field is set by the server when a graceful deletion is requested by the user, and is not directly settable by a client. The resource is expected to be deleted (no longer visible from resource lists, and not reachable by name) after the time in this field, once the finalizers list is empty. As long as the finalizers list contains items, deletion is blocked. Once the deletionTimestamp is set, this value may not be unset or be set further into the future, although it may be shortened or the resource may be deleted prior to this time. For example, a user may request that a pod is deleted in 30 seconds. The Kubelet will react by sending a graceful termination signal to the containers in the pod. After that 30 seconds, the Kubelet will send a hard termination signal (SIGKILL) to the container and after cleanup, remove the pod from the API. In the presence of network partitions, this object may still exist after this timestamp, until an administrator or automated process can determine the resource is fully terminated. If not set, graceful deletion of the object has not been requested.  Populated by the system when a graceful deletion is requested. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata

        :param deletion_timestamp: The deletion_timestamp of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
    ...
    def generation(self):
        """
        Gets the generation of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        A sequence number representing a specific generation of the desired state. Populated by the system. Read-only.

        :return: The generation of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :rtype: int
        """
    ...
    def generation(self, generation):
        """
        Sets the generation of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        A sequence number representing a specific generation of the desired state. Populated by the system. Read-only.

        :param generation: The generation of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :type: int
        """
    ...
    def managed_fields(self):
        """
        Gets the managed_fields of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        ManagedFields maps workflow-id and version to the set of fields that are managed by that workflow. This is mostly for internal housekeeping, and users typically shouldn't need to set or understand this field. A workflow can be the user's name, a controller's name, or the name of a specific apply path like \"ci-cd\". The set of fields is always in the version that the workflow used when modifying the object.

        :return: The managed_fields of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :rtype: list[K8sIoApimachineryPkgApisMetaV1ManagedFieldsEntry]
        """
    ...
    def managed_fields(self, managed_fields):
        """
        Sets the managed_fields of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        ManagedFields maps workflow-id and version to the set of fields that are managed by that workflow. This is mostly for internal housekeeping, and users typically shouldn't need to set or understand this field. A workflow can be the user's name, a controller's name, or the name of a specific apply path like \"ci-cd\". The set of fields is always in the version that the workflow used when modifying the object.

        :param managed_fields: The managed_fields of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :type: list[K8sIoApimachineryPkgApisMetaV1ManagedFieldsEntry]
        """
    ...
    def owner_references(self):
        """
        Gets the owner_references of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller.

        :return: The owner_references of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :rtype: list[K8sIoApimachineryPkgApisMetaV1OwnerReference]
        """
    ...
    def owner_references(self, owner_references):
        """
        Sets the owner_references of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller.

        :param owner_references: The owner_references of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :type: list[K8sIoApimachineryPkgApisMetaV1OwnerReference]
        """
    ...
    def resource_version(self):
        """
        Gets the resource_version of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        ...
        :return: The resource_version of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :rtype: str
        """
    ...
    def resource_version(self, resource_version):
        """
        Sets the resource_version of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        An opaque value that represents the internal version of this object that can be used by clients to determine when objects have changed. May be used for optimistic concurrency, change detection, and the watch operation on a resource or set of resources. Clients must treat these values as opaque and passed unmodified back to the server. They may only be valid for a particular resource or set of resources.  Populated by the system. Read-only. Value must be treated as opaque by clients and . More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency

        :param resource_version: The resource_version of this K8sIoApimachineryPkgApisMetaV1ObjectMeta.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, K8sIoApimachineryPkgApisMetaV1ObjectMeta):
            return False
