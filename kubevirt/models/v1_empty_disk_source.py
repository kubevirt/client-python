...
class V1EmptyDiskSource(object):
    """
    ...
    def __init__(self, capacity=None):
        """
        V1EmptyDiskSource - a model defined in Swagger
        """
    ...
    def capacity(self):
        """
        Gets the capacity of this V1EmptyDiskSource.
    ...
    def capacity(self, capacity):
        """
        Sets the capacity of this V1EmptyDiskSource.
        Capacity of the sparse disk.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1EmptyDiskSource):
            return False
