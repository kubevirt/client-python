...
class V1ResourceRequirementsWithoutClaims(object):
    """
    ...
    def __init__(self, limits=None, requests=None):
        """
        V1ResourceRequirementsWithoutClaims - a model defined in Swagger
        """
    ...
    def limits(self):
        """
        Gets the limits of this V1ResourceRequirementsWithoutClaims.
    ...
    def limits(self, limits):
        """
        Sets the limits of this V1ResourceRequirementsWithoutClaims.
        Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
    ...
    def requests(self):
        """
        Gets the requests of this V1ResourceRequirementsWithoutClaims.
    ...
    def requests(self, requests):
        """
        Sets the requests of this V1ResourceRequirementsWithoutClaims.
        Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. Requests cannot exceed Limits. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1ResourceRequirementsWithoutClaims):
            return False
