...
class V1VirtualMachineExportSpec(object):
    """
    ...
    def __init__(self, source=None, token_secret_ref=None, ttl_duration=None):
        """
        V1VirtualMachineExportSpec - a model defined in Swagger
        """
    ...
    def token_secret_ref(self):
        """
        Gets the token_secret_ref of this V1VirtualMachineExportSpec.
        TokenSecretRef is the name of the custom-defined secret that contains the token used by the export server pod

        :return: The token_secret_ref of this V1VirtualMachineExportSpec.
        :rtype: str
        """
    ...
    def token_secret_ref(self, token_secret_ref):
        """
        Sets the token_secret_ref of this V1VirtualMachineExportSpec.
        TokenSecretRef is the name of the custom-defined secret that contains the token used by the export server pod

        :param token_secret_ref: The token_secret_ref of this V1VirtualMachineExportSpec.
        :type: str
        """
    ...
    def ttl_duration(self):
        """
        Gets the ttl_duration of this V1VirtualMachineExportSpec.
    ...
    def ttl_duration(self, ttl_duration):
        """
        Sets the ttl_duration of this V1VirtualMachineExportSpec.
        ttlDuration limits the lifetime of an export If this field is set, after this duration has passed from counting from CreationTimestamp, the export is eligible to be automatically deleted. If this field is omitted, a reasonable default is applied.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1VirtualMachineExportSpec):
            return False
