...
class V1VirtualMachineExportStatus(object):
    """
    ...
    def __init__(self, conditions=None, links=None, phase=None, service_name=None, token_secret_ref=None, ttl_expiration_time=None, virtual_machine_name=None):
        """
        V1VirtualMachineExportStatus - a model defined in Swagger
        """
    ...
    def conditions(self):
        """
        Gets the conditions of this V1VirtualMachineExportStatus.

        :return: The conditions of this V1VirtualMachineExportStatus.
    ...
    def conditions(self, conditions):
        """
        Sets the conditions of this V1VirtualMachineExportStatus.

        :param conditions: The conditions of this V1VirtualMachineExportStatus.
    ...
    def links(self):
        """
        Gets the links of this V1VirtualMachineExportStatus.

        :return: The links of this V1VirtualMachineExportStatus.
        :rtype: V1VirtualMachineExportLinks
        """
        return self._links
    ...
    def links(self, links):
        """
        Sets the links of this V1VirtualMachineExportStatus.

        :param links: The links of this V1VirtualMachineExportStatus.
    ...
    def phase(self):
        """
        Gets the phase of this V1VirtualMachineExportStatus.

        :return: The phase of this V1VirtualMachineExportStatus.
        :rtype: str
        """
        return self._phase
    ...
    def phase(self, phase):
        """
        Sets the phase of this V1VirtualMachineExportStatus.

        :param phase: The phase of this V1VirtualMachineExportStatus.
        :type: str
        """
    ...
    def service_name(self):
        """
        Gets the service_name of this V1VirtualMachineExportStatus.
        ...
        :return: The service_name of this V1VirtualMachineExportStatus.
        :rtype: str
        """
    ...
    def service_name(self, service_name):
        """
        Sets the service_name of this V1VirtualMachineExportStatus.
        ServiceName is the name of the service created associated with the Virtual Machine export. It will be used to create the internal URLs for downloading the images

        :param service_name: The service_name of this V1VirtualMachineExportStatus.
        :type: str
        """
    ...
    def token_secret_ref(self):
        """
        Gets the token_secret_ref of this V1VirtualMachineExportStatus.
        TokenSecretRef is the name of the secret that contains the token used by the export server pod

        :return: The token_secret_ref of this V1VirtualMachineExportStatus.
        :rtype: str
        """
    ...
    def token_secret_ref(self, token_secret_ref):
        """
        Sets the token_secret_ref of this V1VirtualMachineExportStatus.
        TokenSecretRef is the name of the secret that contains the token used by the export server pod

        :param token_secret_ref: The token_secret_ref of this V1VirtualMachineExportStatus.
        :type: str
        """
    ...
    def ttl_expiration_time(self):
        """
        Gets the ttl_expiration_time of this V1VirtualMachineExportStatus.
    ...
    def ttl_expiration_time(self, ttl_expiration_time):
        """
        Sets the ttl_expiration_time of this V1VirtualMachineExportStatus.
        The time at which the VM Export will be completely removed according to specified TTL Formula is CreationTimestamp + TTL
    ...
    def virtual_machine_name(self):
        """
        Gets the virtual_machine_name of this V1VirtualMachineExportStatus.
        ...
        :return: The virtual_machine_name of this V1VirtualMachineExportStatus.
        :rtype: str
        """
    ...
    def virtual_machine_name(self, virtual_machine_name):
        """
        Sets the virtual_machine_name of this V1VirtualMachineExportStatus.
        VirtualMachineName shows the name of the source virtual machine if the source is either a VirtualMachine or a VirtualMachineSnapshot. This is mainly to easily identify the source VirtualMachine in case of a VirtualMachineSnapshot

        :param virtual_machine_name: The virtual_machine_name of this V1VirtualMachineExportStatus.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1VirtualMachineExportStatus):
            return False
