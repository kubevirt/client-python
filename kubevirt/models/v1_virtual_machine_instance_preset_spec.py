...
class V1VirtualMachineInstancePresetSpec(object):
    ...
    def __init__(self, domain=None, selector=None):
        """
        V1VirtualMachineInstancePresetSpec - a model defined in Swagger
        """
    ...
    def domain(self):
        """
        Gets the domain of this V1VirtualMachineInstancePresetSpec.
    ...
    def selector(self):
        """
        Gets the selector of this V1VirtualMachineInstancePresetSpec.
