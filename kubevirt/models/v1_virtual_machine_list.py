...
class V1VirtualMachineList(object):
    """
    ...
    def __init__(self, api_version=None, items=None, kind=None, metadata=None):
        """
        V1VirtualMachineList - a model defined in Swagger
        """
    ...
    def api_version(self):
        """
        Gets the api_version of this V1VirtualMachineList.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#resources

        :return: The api_version of this V1VirtualMachineList.
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        """
        Sets the api_version of this V1VirtualMachineList.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#resources

        :param api_version: The api_version of this V1VirtualMachineList.
        :type: str
        """
    ...
    def kind(self):
        """
        Gets the kind of this V1VirtualMachineList.
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds

        :return: The kind of this V1VirtualMachineList.
        :rtype: str
        """
        return self._kind
    ...
    def kind(self, kind):
        """
        Sets the kind of this V1VirtualMachineList.
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds

        :param kind: The kind of this V1VirtualMachineList.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1VirtualMachineList):
            return False
