...
class V1VMIMConfigurationOptions(object):
    """
    ...
    def __init__(self, allow_auto_converge=None, allow_post_copy=None, allow_workload_disruption=None, bandwidth_per_migration=None, completion_timeout_per_gi_b=None, disable_tls=None, experimental=None, match_se_linux_level_on_migration=None, max_downtime_ms=None, network=None, node_drain_taint_key=None, parallel_migrations_per_cluster=None, parallel_outbound_migrations_per_node=None, progress_timeout=None, unsafe_migration_override=None, utility_volumes_timeout=None):
        """
        V1VMIMConfigurationOptions - a model defined in Swagger
        """
    ...
    def allow_auto_converge(self):
        """
        Gets the allow_auto_converge of this V1VMIMConfigurationOptions.
        ...
        :return: The allow_auto_converge of this V1VMIMConfigurationOptions.
        :rtype: bool
        """
    ...
    def allow_auto_converge(self, allow_auto_converge):
        """
        Sets the allow_auto_converge of this V1VMIMConfigurationOptions.
        AllowAutoConverge allows the platform to compromise performance/availability of VMIs to guarantee successful VMI live migrations. Defaults to false

        :param allow_auto_converge: The allow_auto_converge of this V1VMIMConfigurationOptions.
        :type: bool
        """
    ...
    def allow_post_copy(self):
        """
        Gets the allow_post_copy of this V1VMIMConfigurationOptions.
        ...
        :return: The allow_post_copy of this V1VMIMConfigurationOptions.
        :rtype: bool
        """
    ...
    def allow_post_copy(self, allow_post_copy):
        """
        Sets the allow_post_copy of this V1VMIMConfigurationOptions.
        AllowPostCopy enables post-copy live migrations. Such migrations allow even the busiest VMIs to successfully live-migrate. However, events like a network failure can cause a VMI crash. If set to true, migrations will still start in pre-copy, but switch to post-copy when CompletionTimeoutPerGiB triggers. Defaults to false

        :param allow_post_copy: The allow_post_copy of this V1VMIMConfigurationOptions.
        :type: bool
        """
    ...
    def allow_workload_disruption(self):
        """
        Gets the allow_workload_disruption of this V1VMIMConfigurationOptions.
        ...
        :return: The allow_workload_disruption of this V1VMIMConfigurationOptions.
        :rtype: bool
        """
    ...
    def allow_workload_disruption(self, allow_workload_disruption):
        """
        Sets the allow_workload_disruption of this V1VMIMConfigurationOptions.
        AllowWorkloadDisruption indicates that the migration shouldn't be canceled after acceptableCompletionTime is exceeded. Instead, if permitted, migration will be switched to post-copy or the VMI will be paused to allow the migration to complete

        :param allow_workload_disruption: The allow_workload_disruption of this V1VMIMConfigurationOptions.
        :type: bool
        """
    ...
    def bandwidth_per_migration(self):
        """
        Gets the bandwidth_per_migration of this V1VMIMConfigurationOptions.
    ...
    def bandwidth_per_migration(self, bandwidth_per_migration):
        """
        Sets the bandwidth_per_migration of this V1VMIMConfigurationOptions.
        BandwidthPerMigration limits the amount of network bandwidth live migrations are allowed to use. The value is in quantity per second. Defaults to 0 (no limit)
    ...
    def completion_timeout_per_gi_b(self):
        """
        Gets the completion_timeout_per_gi_b of this V1VMIMConfigurationOptions.
        ...
        :return: The completion_timeout_per_gi_b of this V1VMIMConfigurationOptions.
        :rtype: int
        """
    ...
    def completion_timeout_per_gi_b(self, completion_timeout_per_gi_b):
        """
        Sets the completion_timeout_per_gi_b of this V1VMIMConfigurationOptions.
        CompletionTimeoutPerGiB is the maximum number of seconds per GiB a migration is allowed to take. If the timeout is reached, the migration will be either paused, switched to post-copy or cancelled depending on other settings. Defaults to 150

        :param completion_timeout_per_gi_b: The completion_timeout_per_gi_b of this V1VMIMConfigurationOptions.
        :type: int
        """
    ...
    def experimental(self):
        """
        Gets the experimental of this V1VMIMConfigurationOptions.
        ...
        :return: The experimental of this V1VMIMConfigurationOptions.
    ...
    def experimental(self, experimental):
        """
        Sets the experimental of this V1VMIMConfigurationOptions.
        ExperimentalMigrationOptions is an alpha API. It is intended for experimental purposes only and will be removed in the future.

        :param experimental: The experimental of this V1VMIMConfigurationOptions.
    ...
    def match_se_linux_level_on_migration(self):
        """
        Gets the match_se_linux_level_on_migration of this V1VMIMConfigurationOptions.
        ...
        :return: The match_se_linux_level_on_migration of this V1VMIMConfigurationOptions.
        :rtype: bool
        """
    ...
    def match_se_linux_level_on_migration(self, match_se_linux_level_on_migration):
        """
        Sets the match_se_linux_level_on_migration of this V1VMIMConfigurationOptions.
        By default, the SELinux level of target virt-launcher pods is forced to the level of the source virt-launcher. When set to true, MatchSELinuxLevelOnMigration lets the CRI auto-assign a random level to the target. That will ensure the target virt-launcher doesn't share categories with another pod on the node. However, migrations will fail when using RWX volumes that don't automatically deal with SELinux levels.

        :param match_se_linux_level_on_migration: The match_se_linux_level_on_migration of this V1VMIMConfigurationOptions.
        :type: bool
        """
    ...
    def max_downtime_ms(self):
        """
        Gets the max_downtime_ms of this V1VMIMConfigurationOptions.
        MaxDowntimeMs specifies the maximum tolerable downtime (in milliseconds) during switchover. Defaults to 900

        :return: The max_downtime_ms of this V1VMIMConfigurationOptions.
        :rtype: int
        """
    ...
    def max_downtime_ms(self, max_downtime_ms):
        """
        Sets the max_downtime_ms of this V1VMIMConfigurationOptions.
        MaxDowntimeMs specifies the maximum tolerable downtime (in milliseconds) during switchover. Defaults to 900

        :param max_downtime_ms: The max_downtime_ms of this V1VMIMConfigurationOptions.
        :type: int
        """
    ...
    def network(self, network):
        """
        Sets the network of this V1VMIMConfigurationOptions.
        Network is the name of the CNI network to use for live migrations. By default, migrations go through the pod network.

        :param network: The network of this V1VMIMConfigurationOptions.
        :type: str
        """
    ...
    def node_drain_taint_key(self):
        """
        Gets the node_drain_taint_key of this V1VMIMConfigurationOptions.
        ...
        :return: The node_drain_taint_key of this V1VMIMConfigurationOptions.
        :rtype: str
        """
    ...
    def node_drain_taint_key(self, node_drain_taint_key):
        """
        Sets the node_drain_taint_key of this V1VMIMConfigurationOptions.
        NodeDrainTaintKey defines the taint key that indicates a node should be drained. Note: this option relies on the deprecated node taint feature. Default: kubevirt.io/drain

        :param node_drain_taint_key: The node_drain_taint_key of this V1VMIMConfigurationOptions.
        :type: str
        """
    ...
    def parallel_migrations_per_cluster(self):
        """
        Gets the parallel_migrations_per_cluster of this V1VMIMConfigurationOptions.
        ParallelMigrationsPerCluster is the total number of concurrent live migrations allowed cluster-wide. Defaults to 5

        :return: The parallel_migrations_per_cluster of this V1VMIMConfigurationOptions.
        :rtype: int
        """
    ...
    def parallel_migrations_per_cluster(self, parallel_migrations_per_cluster):
        """
        Sets the parallel_migrations_per_cluster of this V1VMIMConfigurationOptions.
        ParallelMigrationsPerCluster is the total number of concurrent live migrations allowed cluster-wide. Defaults to 5

        :param parallel_migrations_per_cluster: The parallel_migrations_per_cluster of this V1VMIMConfigurationOptions.
        :type: int
        """
    ...
    def parallel_outbound_migrations_per_node(self):
        """
        Gets the parallel_outbound_migrations_per_node of this V1VMIMConfigurationOptions.
        ...
        :return: The parallel_outbound_migrations_per_node of this V1VMIMConfigurationOptions.
        :rtype: int
        """
    ...
    def parallel_outbound_migrations_per_node(self, parallel_outbound_migrations_per_node):
        """
        Sets the parallel_outbound_migrations_per_node of this V1VMIMConfigurationOptions.
        ParallelOutboundMigrationsPerNode is the maximum number of concurrent outgoing live migrations allowed per node. Defaults to 2

        :param parallel_outbound_migrations_per_node: The parallel_outbound_migrations_per_node of this V1VMIMConfigurationOptions.
        :type: int
        """
    ...
    def progress_timeout(self):
        """
        Gets the progress_timeout of this V1VMIMConfigurationOptions.
        ...
        :return: The progress_timeout of this V1VMIMConfigurationOptions.
        :rtype: int
        """
    ...
    def progress_timeout(self, progress_timeout):
        """
        Sets the progress_timeout of this V1VMIMConfigurationOptions.
        ProgressTimeout is the maximum number of seconds a live migration is allowed to make no progress. Hitting this timeout means a migration transferred 0 data for that many seconds. The migration is then considered stuck and therefore cancelled. Defaults to 150

        :param progress_timeout: The progress_timeout of this V1VMIMConfigurationOptions.
        :type: int
        """
    ...
    def unsafe_migration_override(self):
        """
        Gets the unsafe_migration_override of this V1VMIMConfigurationOptions.
        ...
        :return: The unsafe_migration_override of this V1VMIMConfigurationOptions.
        :rtype: bool
        """
    ...
    def unsafe_migration_override(self, unsafe_migration_override):
        """
        Sets the unsafe_migration_override of this V1VMIMConfigurationOptions.
        UnsafeMigrationOverride allows live migrations to occur even if the compatibility check indicates the migration will be unsafe to the guest. Defaults to false

        :param unsafe_migration_override: The unsafe_migration_override of this V1VMIMConfigurationOptions.
        :type: bool
        """
    ...
    def utility_volumes_timeout(self):
        """
        Gets the utility_volumes_timeout of this V1VMIMConfigurationOptions.
        ...
        :return: The utility_volumes_timeout of this V1VMIMConfigurationOptions.
        :rtype: int
        """
    ...
    def utility_volumes_timeout(self, utility_volumes_timeout):
        """
        Sets the utility_volumes_timeout of this V1VMIMConfigurationOptions.
        UtilityVolumesTimeout is the maximum number of seconds a migration can wait in Pending state for utility volumes to be detached. If utility volumes are still present after this timeout, the migration will be marked as Failed. Defaults to 150

        :param utility_volumes_timeout: The utility_volumes_timeout of this V1VMIMConfigurationOptions.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1VMIMConfigurationOptions):
            return False
