...
class V1alpha1CPUFlavor(object):
    """
    ...
    def __init__(self, dedicated_cpu_placement=None, guest=None, isolate_emulator_thread=None, model=None, numa=None, realtime=None):
        """
        V1alpha1CPUFlavor - a model defined in Swagger
        """
    ...
    def dedicated_cpu_placement(self):
        """
        Gets the dedicated_cpu_placement of this V1alpha1CPUFlavor.
        ...
        :return: The dedicated_cpu_placement of this V1alpha1CPUFlavor.
        :rtype: bool
        """
    ...
    def dedicated_cpu_placement(self, dedicated_cpu_placement):
        """
        Sets the dedicated_cpu_placement of this V1alpha1CPUFlavor.
        DedicatedCPUPlacement requests the scheduler to place the VirtualMachineInstance on a node with enough dedicated pCPUs and pin the vCPUs to it.

        :param dedicated_cpu_placement: The dedicated_cpu_placement of this V1alpha1CPUFlavor.
        :type: bool
        """
    ...
    def guest(self):
        """
        Gets the guest of this V1alpha1CPUFlavor.
        ...
        :return: The guest of this V1alpha1CPUFlavor.
        :rtype: int
        """
        return self._guest
    ...
    def guest(self, guest):
        """
        Sets the guest of this V1alpha1CPUFlavor.
        Required number of vCPUs to expose to the guest.  The resulting CPU topology being derived from the optional PreferredCPUTopology attribute of CPUPreferences that itself defaults to PreferCores.

        :param guest: The guest of this V1alpha1CPUFlavor.
        :type: int
        """
        if guest is None:
    ...
    def isolate_emulator_thread(self):
        """
        Gets the isolate_emulator_thread of this V1alpha1CPUFlavor.
        IsolateEmulatorThread requests one more dedicated pCPU to be allocated for the VMI to place the emulator thread on it.

        :return: The isolate_emulator_thread of this V1alpha1CPUFlavor.
        :rtype: bool
        """
    ...
    def isolate_emulator_thread(self, isolate_emulator_thread):
        """
        Sets the isolate_emulator_thread of this V1alpha1CPUFlavor.
        IsolateEmulatorThread requests one more dedicated pCPU to be allocated for the VMI to place the emulator thread on it.

        :param isolate_emulator_thread: The isolate_emulator_thread of this V1alpha1CPUFlavor.
        :type: bool
        """
    ...
    def model(self):
        """
        Gets the model of this V1alpha1CPUFlavor.
        ...
        :return: The model of this V1alpha1CPUFlavor.
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """
        Sets the model of this V1alpha1CPUFlavor.
        Model specifies the CPU model inside the VMI. List of available models https://github.com/libvirt/libvirt/tree/master/src/cpu_map. It is possible to specify special cases like \"host-passthrough\" to get the same CPU as the node and \"host-model\" to get CPU closest to the node one. Defaults to host-model.

        :param model: The model of this V1alpha1CPUFlavor.
        :type: str
        """
    ...
    def numa(self):
        """
        Gets the numa of this V1alpha1CPUFlavor.
    ...
    def numa(self, numa):
        """
        Sets the numa of this V1alpha1CPUFlavor.
        NUMA allows specifying settings for the guest NUMA topology
    ...
    def realtime(self):
        """
        Gets the realtime of this V1alpha1CPUFlavor.
        Realtime instructs the virt-launcher to tune the VMI for lower latency, optional for real time workloads

        :return: The realtime of this V1alpha1CPUFlavor.
        :rtype: V1Realtime
        """
    ...
    def realtime(self, realtime):
        """
        Sets the realtime of this V1alpha1CPUFlavor.
        Realtime instructs the virt-launcher to tune the VMI for lower latency, optional for real time workloads

        :param realtime: The realtime of this V1alpha1CPUFlavor.
        :type: V1Realtime
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1alpha1CPUFlavor):
            return False
