...
class V1alpha1DataVolumeSourceRegistry(object):
    """
    ...
    def secret_ref(self):
        """
        Gets the secret_ref of this V1alpha1DataVolumeSourceRegistry.
        SecretRef provides the secret reference needed to access the Registry source

        :return: The secret_ref of this V1alpha1DataVolumeSourceRegistry.
        :rtype: str
        """
    ...
    def secret_ref(self, secret_ref):
        """
        Sets the secret_ref of this V1alpha1DataVolumeSourceRegistry.
        SecretRef provides the secret reference needed to access the Registry source

        :param secret_ref: The secret_ref of this V1alpha1DataVolumeSourceRegistry.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1alpha1DataVolumeSourceRegistry):
            return False
