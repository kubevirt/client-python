...
class V1alpha1FirmwarePreferences(object):
    """
    ...
    def __init__(self, preferred_use_bios=None, preferred_use_bios_serial=None, preferred_use_efi=None, preferred_use_secure_boot=None):
        """
        V1alpha1FirmwarePreferences - a model defined in Swagger
        """
    ...
    def preferred_use_bios(self):
        """
        Gets the preferred_use_bios of this V1alpha1FirmwarePreferences.
        PreferredUseBios optionally enables BIOS

        :return: The preferred_use_bios of this V1alpha1FirmwarePreferences.
        :rtype: bool
        """
    ...
    def preferred_use_bios(self, preferred_use_bios):
        """
        Sets the preferred_use_bios of this V1alpha1FirmwarePreferences.
        PreferredUseBios optionally enables BIOS

        :param preferred_use_bios: The preferred_use_bios of this V1alpha1FirmwarePreferences.
        :type: bool
        """
    ...
    def preferred_use_bios_serial(self):
        """
        Gets the preferred_use_bios_serial of this V1alpha1FirmwarePreferences.
        PreferredUseBiosSerial optionally transmitts BIOS output over the serial.  Requires PreferredUseBios to be enabled.

        :return: The preferred_use_bios_serial of this V1alpha1FirmwarePreferences.
        :rtype: bool
        """
    ...
    def preferred_use_bios_serial(self, preferred_use_bios_serial):
        """
        Sets the preferred_use_bios_serial of this V1alpha1FirmwarePreferences.
        PreferredUseBiosSerial optionally transmitts BIOS output over the serial.  Requires PreferredUseBios to be enabled.

        :param preferred_use_bios_serial: The preferred_use_bios_serial of this V1alpha1FirmwarePreferences.
        :type: bool
        """
    ...
    def preferred_use_efi(self):
        """
        Gets the preferred_use_efi of this V1alpha1FirmwarePreferences.
        PreferredUseEfi optionally enables EFI

        :return: The preferred_use_efi of this V1alpha1FirmwarePreferences.
        :rtype: bool
        """
    ...
    def preferred_use_efi(self, preferred_use_efi):
        """
        Sets the preferred_use_efi of this V1alpha1FirmwarePreferences.
        PreferredUseEfi optionally enables EFI

        :param preferred_use_efi: The preferred_use_efi of this V1alpha1FirmwarePreferences.
        :type: bool
        """
    ...
    def preferred_use_secure_boot(self):
        """
        Gets the preferred_use_secure_boot of this V1alpha1FirmwarePreferences.
        ...
        :return: The preferred_use_secure_boot of this V1alpha1FirmwarePreferences.
        :rtype: bool
        """
    ...
    def preferred_use_secure_boot(self, preferred_use_secure_boot):
        """
        Sets the preferred_use_secure_boot of this V1alpha1FirmwarePreferences.
        PreferredUseSecureBoot optionally enables SecureBoot and the OVMF roms will be swapped for SecureBoot-enabled ones.  Requires PreferredUseEfi and PreferredSmm to be enabled.

        :param preferred_use_secure_boot: The preferred_use_secure_boot of this V1alpha1FirmwarePreferences.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1alpha1FirmwarePreferences):
            return False
