...
class V1alpha1MachinePreferences(object):
    """
    ...
    def __init__(self, preferred_machine_type=None):
        """
        V1alpha1MachinePreferences - a model defined in Swagger
        """
    ...
    def preferred_machine_type(self):
        """
        Gets the preferred_machine_type of this V1alpha1MachinePreferences.
        PreferredMachineType optionally defines the preferred machine type to use.

        :return: The preferred_machine_type of this V1alpha1MachinePreferences.
        :rtype: str
        """
    ...
    def preferred_machine_type(self, preferred_machine_type):
        """
        Sets the preferred_machine_type of this V1alpha1MachinePreferences.
        PreferredMachineType optionally defines the preferred machine type to use.

        :param preferred_machine_type: The preferred_machine_type of this V1alpha1MachinePreferences.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1alpha1MachinePreferences):
            return False
