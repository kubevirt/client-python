...
class V1alpha1VirtualMachineExportSpec(object):
    """
    ...
    def source(self):
        """
        Gets the source of this V1alpha1VirtualMachineExportSpec.

        :return: The source of this V1alpha1VirtualMachineExportSpec.
    ...
    def source(self, source):
        """
        Sets the source of this V1alpha1VirtualMachineExportSpec.

        :param source: The source of this V1alpha1VirtualMachineExportSpec.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1alpha1VirtualMachineExportSpec):
            return False
