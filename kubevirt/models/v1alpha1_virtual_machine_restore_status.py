...
class V1alpha1VirtualMachineRestoreStatus(object):
    """
    ...
    swagger_types = {
        ...
        'restore_time': 'V1Time',
        'restores': 'list[V1alpha1VolumeRestore]'
    }
    ...
    def __init__(self, complete=None, conditions=None, deleted_data_volumes=None, restore_time=None, restores=None):
        """
        V1alpha1VirtualMachineRestoreStatus - a model defined in Swagger
        """
    ...
    def complete(self):
        """
        Gets the complete of this V1alpha1VirtualMachineRestoreStatus.
    ...
    def complete(self, complete):
        """
        Sets the complete of this V1alpha1VirtualMachineRestoreStatus.
    ...
    def conditions(self):
        """
        Gets the conditions of this V1alpha1VirtualMachineRestoreStatus.
    ...
    def conditions(self, conditions):
        """
        Sets the conditions of this V1alpha1VirtualMachineRestoreStatus.
    ...
    def deleted_data_volumes(self):
        """
        Gets the deleted_data_volumes of this V1alpha1VirtualMachineRestoreStatus.
    ...
    def deleted_data_volumes(self, deleted_data_volumes):
        """
        Sets the deleted_data_volumes of this V1alpha1VirtualMachineRestoreStatus.
    ...
    def restore_time(self):
        """
        Gets the restore_time of this V1alpha1VirtualMachineRestoreStatus.

        :return: The restore_time of this V1alpha1VirtualMachineRestoreStatus.
        :rtype: V1Time
        """
    ...
    def restore_time(self, restore_time):
        """
        Sets the restore_time of this V1alpha1VirtualMachineRestoreStatus.

        :param restore_time: The restore_time of this V1alpha1VirtualMachineRestoreStatus.
        :type: V1Time
        """
    ...
    def restores(self):
        """
        Gets the restores of this V1alpha1VirtualMachineRestoreStatus.

        :return: The restores of this V1alpha1VirtualMachineRestoreStatus.
        :rtype: list[V1alpha1VolumeRestore]
        """
    ...
    def restores(self, restores):
        """
        Sets the restores of this V1alpha1VirtualMachineRestoreStatus.

        :param restores: The restores of this V1alpha1VirtualMachineRestoreStatus.
        :type: list[V1alpha1VolumeRestore]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1alpha1VirtualMachineRestoreStatus):
            return False
