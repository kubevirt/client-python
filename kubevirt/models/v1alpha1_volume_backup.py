...
class V1alpha1VolumeBackup(object):
    ...
    def __init__(self, disk_name=None, persistent_volume_claim=None, volume_snapshot_name=None):
        """
    ...
    def disk_name(self):
        """
        Gets the disk_name of this V1alpha1VolumeBackup.

        :return: The disk_name of this V1alpha1VolumeBackup.
        :rtype: str
        """
    ...
    def disk_name(self, disk_name):
        """
        Sets the disk_name of this V1alpha1VolumeBackup.

        :param disk_name: The disk_name of this V1alpha1VolumeBackup.
        :type: str
        """
