...
class V1alpha1VolumeBackup(object):
    """
    ...
    """
    swagger_types = {
        'persistent_volume_claim': 'V1alpha1PersistentVolumeClaim',
        'volume_name': 'str',
    ...
    def persistent_volume_claim(self):
        ...
        :rtype: V1alpha1PersistentVolumeClaim
        """
    ...
    def volume_name(self):
        """
        Gets the volume_name of this V1alpha1VolumeBackup.

        :return: The volume_name of this V1alpha1VolumeBackup.
        :rtype: str
        """
    ...
    def volume_name(self, volume_name):
        """
        Sets the volume_name of this V1alpha1VolumeBackup.

        :param volume_name: The volume_name of this V1alpha1VolumeBackup.
        :type: str
        """
    ...
    def volume_snapshot_name(self):
        """
        Gets the volume_snapshot_name of this V1alpha1VolumeBackup.

        :return: The volume_snapshot_name of this V1alpha1VolumeBackup.
        :rtype: str
        """
    ...
    def volume_snapshot_name(self, volume_snapshot_name):
        """
        Sets the volume_snapshot_name of this V1alpha1VolumeBackup.

        :param volume_snapshot_name: The volume_snapshot_name of this V1alpha1VolumeBackup.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1alpha1VolumeBackup):
            return False
