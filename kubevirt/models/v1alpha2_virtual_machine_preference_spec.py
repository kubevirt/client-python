...
class V1alpha2VirtualMachinePreferenceSpec(object):
    """
    ...
    def clock(self):
        """
        Gets the clock of this V1alpha2VirtualMachinePreferenceSpec.
        Clock optionally defines preferences associated with the Clock attribute of a VirtualMachineInstance DomainSpec

        :return: The clock of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def clock(self, clock):
        """
        Sets the clock of this V1alpha2VirtualMachinePreferenceSpec.
        Clock optionally defines preferences associated with the Clock attribute of a VirtualMachineInstance DomainSpec

        :param clock: The clock of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def cpu(self):
        """
        Gets the cpu of this V1alpha2VirtualMachinePreferenceSpec.
        CPU optionally defines preferences associated with the CPU attribute of a VirtualMachineInstance DomainSpec

        :return: The cpu of this V1alpha2VirtualMachinePreferenceSpec.
        :rtype: V1alpha2CPUPreferences
        """
        return self._cpu
    ...
    def cpu(self, cpu):
        """
        Sets the cpu of this V1alpha2VirtualMachinePreferenceSpec.
        CPU optionally defines preferences associated with the CPU attribute of a VirtualMachineInstance DomainSpec

        :param cpu: The cpu of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def devices(self):
        """
        Gets the devices of this V1alpha2VirtualMachinePreferenceSpec.
        Devices optionally defines preferences associated with the Devices attribute of a VirtualMachineInstance DomainSpec

        :return: The devices of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def devices(self, devices):
        """
        Sets the devices of this V1alpha2VirtualMachinePreferenceSpec.
        Devices optionally defines preferences associated with the Devices attribute of a VirtualMachineInstance DomainSpec

        :param devices: The devices of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def features(self):
        """
        Gets the features of this V1alpha2VirtualMachinePreferenceSpec.
        Features optionally defines preferences associated with the Features attribute of a VirtualMachineInstance DomainSpec

        :return: The features of this V1alpha2VirtualMachinePreferenceSpec.
        :rtype: V1alpha2FeaturePreferences
        """
    ...
    def features(self, features):
        """
        Sets the features of this V1alpha2VirtualMachinePreferenceSpec.
        Features optionally defines preferences associated with the Features attribute of a VirtualMachineInstance DomainSpec

        :param features: The features of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def firmware(self):
        """
        Gets the firmware of this V1alpha2VirtualMachinePreferenceSpec.
        Firmware optionally defines preferences associated with the Firmware attribute of a VirtualMachineInstance DomainSpec

        :return: The firmware of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def firmware(self, firmware):
        """
        Sets the firmware of this V1alpha2VirtualMachinePreferenceSpec.
        Firmware optionally defines preferences associated with the Firmware attribute of a VirtualMachineInstance DomainSpec

        :param firmware: The firmware of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def machine(self):
        """
        Gets the machine of this V1alpha2VirtualMachinePreferenceSpec.
        Machine optionally defines preferences associated with the Machine attribute of a VirtualMachineInstance DomainSpec

        :return: The machine of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def machine(self, machine):
        """
        Sets the machine of this V1alpha2VirtualMachinePreferenceSpec.
        Machine optionally defines preferences associated with the Machine attribute of a VirtualMachineInstance DomainSpec

        :param machine: The machine of this V1alpha2VirtualMachinePreferenceSpec.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1alpha2VirtualMachinePreferenceSpec):
            return False
