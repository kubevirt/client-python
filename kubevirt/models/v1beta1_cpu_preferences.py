...
class V1beta1CPUPreferences(object):
    """
    ...
    def preferred_cpu_topology(self):
        """
        Gets the preferred_cpu_topology of this V1beta1CPUPreferences.
        PreferredCPUTopology optionally defines the preferred guest visible CPU topology, defaults to PreferSockets.

        :return: The preferred_cpu_topology of this V1beta1CPUPreferences.
        :rtype: str
        """
    ...
    def preferred_cpu_topology(self, preferred_cpu_topology):
        """
        Sets the preferred_cpu_topology of this V1beta1CPUPreferences.
        PreferredCPUTopology optionally defines the preferred guest visible CPU topology, defaults to PreferSockets.

        :param preferred_cpu_topology: The preferred_cpu_topology of this V1beta1CPUPreferences.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1beta1CPUPreferences):
            return False
