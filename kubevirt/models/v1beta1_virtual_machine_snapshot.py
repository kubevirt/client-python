...
class V1beta1VirtualMachineSnapshot(object):
    """
    ...
    def __init__(self, api_version=None, kind=None, metadata=None, spec=None, status=None):
        """
        V1beta1VirtualMachineSnapshot - a model defined in Swagger
        """
    ...
    def api_version(self):
        """
        Gets the api_version of this V1beta1VirtualMachineSnapshot.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources

        :return: The api_version of this V1beta1VirtualMachineSnapshot.
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        """
        Sets the api_version of this V1beta1VirtualMachineSnapshot.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources

        :param api_version: The api_version of this V1beta1VirtualMachineSnapshot.
        :type: str
        """
    ...
    def kind(self):
        ...
        :return: The kind of this V1beta1VirtualMachineSnapshot.
        :rtype: str
        """
        return self._kind
    ...
    def kind(self, kind):
        """
        Sets the kind of this V1beta1VirtualMachineSnapshot.
        Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    ...
    def metadata(self, metadata):
        """
        Sets the metadata of this V1beta1VirtualMachineSnapshot.

        :param metadata: The metadata of this V1beta1VirtualMachineSnapshot.
    ...
    def spec(self, spec):
        """
        Sets the spec of this V1beta1VirtualMachineSnapshot.
    ...
    def status(self):
        ...
        :rtype: V1beta1VirtualMachineSnapshotStatus
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this V1beta1VirtualMachineSnapshot.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1beta1VirtualMachineSnapshot):
            return False
