...
class V1ObjectMeta(object):
    ...
    """
    def __init__(self, name=None, generate_name=None, namespace=None, self_link=None, uid=None, resource_version=None, generation=None, creation_timestamp=None, deletion_timestamp=None, deletion_grace_period_seconds=None, labels=None, annotations=None, owner_references=None, initializers=None, finalizers=None, cluster_name=None):
        """
