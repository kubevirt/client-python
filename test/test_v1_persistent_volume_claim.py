...
from kubevirt.models.v1_persistent_volume_claim import V1PersistentVolumeClaim
...
class TestV1PersistentVolumeClaim(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaim(self):
        ...
        #model = kubevirt.models.v1_persistent_volume_claim.V1PersistentVolumeClaim()
        pass
