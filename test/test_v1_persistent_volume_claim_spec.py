...
from kubevirt.models.v1_persistent_volume_claim_spec import V1PersistentVolumeClaimSpec
...
class TestV1PersistentVolumeClaimSpec(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaimSpec(self):
        ...
        #model = kubevirt.models.v1_persistent_volume_claim_spec.V1PersistentVolumeClaimSpec()
        pass
