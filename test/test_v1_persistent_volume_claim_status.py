...
from kubevirt.models.v1_persistent_volume_claim_status import V1PersistentVolumeClaimStatus
...
class TestV1PersistentVolumeClaimStatus(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaimStatus(self):
        ...
        #model = kubevirt.models.v1_persistent_volume_claim_status.V1PersistentVolumeClaimStatus()
        pass
