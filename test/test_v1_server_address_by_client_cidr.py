...
from kubevirt.models.v1_server_address_by_client_cidr import V1ServerAddressByClientCIDR
...
class TestV1ServerAddressByClientCIDR(unittest.TestCase):
    ...
    def testV1ServerAddressByClientCIDR(self):
        ...
        #model = kubevirt.models.v1_server_address_by_client_cidr.V1ServerAddressByClientCIDR()
        pass
