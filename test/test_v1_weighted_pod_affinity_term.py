...
from kubevirt.models.v1_weighted_pod_affinity_term import V1WeightedPodAffinityTerm
...
class TestV1WeightedPodAffinityTerm(unittest.TestCase):
    ...
    def testV1WeightedPodAffinityTerm(self):
        ...
        #model = kubevirt.models.v1_weighted_pod_affinity_term.V1WeightedPodAffinityTerm()
        pass
